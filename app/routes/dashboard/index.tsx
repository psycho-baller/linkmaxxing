...
export default function Page() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-var(--header-height))] bg-gradient-to-b from-[#343D40] to-[#131519]">
      ...
      <div className="flex-grow overflow-auto px-4 sm:px-6 pb-4">
        ...
        <h1
          className="text-xl sm:text-2xl font-normal text-gray-200 mb-6 sm:mb-8 text-center"
      ...
      <div className="flex-shrink-0 pb-6 sm:pb-8 px-4 sm:px-6">
        <div className="space-y-4">
          ...
          <div className="flex justify-between gap-3">
            ...
            <a
              href="/network"
              className="bg-[#353E41] rounded-2xl flex-1 max-w-[160px] h-14 sm:h-16 flex items-center justify-between px-3 sm:px-4 cursor-pointer hover:bg-slate-600 transition-colors">
              <div className="flex items-center gap-2 sm:gap-3">
                <Users className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" />
                <p className="text-white text-xs sm:text-sm">Network</p>
              </div>
            </a>
            ...
            <a
              ...
              className="bg-[#353E41] rounded-2xl w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center hover:bg-slate-600 transition-colors">
          ...
          <div className="">
            <button
              ...
              disabled={isCreating}
              className="w-full bg-white text-black py-3 sm:py-4 rounded-xl font-medium hover:bg-gray-100 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
                ...
                className="text-black mr-2 sm:w-5 sm:h-5">
                <circle cx="12" cy="12" r="1"></circle>
                <circle cx="12" cy="12" r="8"></circle>
              </svg>
              <span className="text-sm sm:text-base">{isCreating ? "Creating..." : "Start Recording"}</span>
            </button>
          </div>
        </div>
      </div>
